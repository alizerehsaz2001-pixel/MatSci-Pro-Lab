...
const STANDARDS = [
  ...
  { id: 'astm-d638', code: 'ASTM D638', org: 'ASTM', prop: 'Tensile', title: 'Standard Test Method for Tensile Properties of Plastics', scope: 'Tensile strength, modulus, and elongation of plastics.', specimen: 'Dumbbell-shaped (Type I-V).', params: 'Test speed.', procedure: ['1. Measure thickness and width.', '2. Secure in grips.', '3. Pull at constant speed.', '4. Record load and extension.'] },
  
  // Compression & Flexural
  { id: 'astm-e9', code: 'ASTM E9', org: 'ASTM', prop: 'Compression', title: 'Standard Test Methods of Compression Testing of Metallic Materials at Room Temperature', scope: 'Determining yield strength and compressive strength.', specimen: 'Cylindrical or prismatic.', params: 'Strain rate, room temperature.', procedure: ['1. Measure dimensions.', '2. Center specimen between platens.', '3. Apply compressive load.', '4. Record load-deformation curve.'] },
  { id: 'astm-d695', code: 'ASTM D695', org: 'ASTM', prop: 'Compression', title: 'Standard Test Method for Compressive Properties of Rigid Plastics', scope: 'Compressive yield, strength, and modulus of plastics.', specimen: 'Right cylinder or prism.', params: 'Displacement rate, load.', procedure: ['1. Measure dimensions.', '2. Place in compression tool.', '3. Compress at specified rate.', '4. Calculate compressive stress and strain.'] },
  { id: 'astm-d790', code: 'ASTM D790', org: 'ASTM', prop: 'Flexural', title: 'Standard Test Methods for Flexural Properties of Unreinforced and Reinforced Plastics', scope: 'Flexural strength and modulus.', specimen: 'Rectangular bar.', params: 'Span-to-depth ratio, crosshead speed.', procedure: ['1. Measure specimen dimensions.', '2. Set support span.', '3. Apply load at the center (3-point bending).', '4. Record load-deflection curve.'] },
  ...
  { id: 'astm-e384', code: 'ASTM E384', org: 'ASTM', prop: 'Hardness', title: 'Standard Test Method for Microindentation Hardness of Materials', scope: 'Vickers and Knoop hardness for small regions or thin layers.', specimen: 'Polished metallographic mount.', params: 'Test load (1 gf to 1 kgf), dwell time.', procedure: ['1. Prepare and polish specimen.', '2. Apply micro-load.', '3. Measure indentation diagonals using microscope.', '4. Calculate HV or HK.'] },
  { id: 'iso-6507-1', code: 'ISO 6507-1', org: 'ISO', prop: 'Hardness', title: 'Metallic materials — Vickers hardness test — Part 1: Test method', scope: 'Vickers hardness of metals.', specimen: 'Flat, polished surface.', params: 'Test force.', procedure: ['1. Position specimen.', '2. Indent with diamond pyramid.', '3. Take optical measurements of diagonals.', '4. Compute Vickers hardness value.'] },
  ...
  { id: 'astm-d256', code: 'ASTM D256', org: 'ASTM', prop: 'Impact', title: 'Standard Test Methods for Determining the Izod Pendulum Impact Resistance of Plastics', scope: 'Impact energy required to break a notched plastic.', specimen: 'Rectangular bar with a machined notch.', params: 'Pendulum capacity, notch radius.', procedure: ['1. Machine V-notch.', '2. Clamp vertically in vise.', '3. Release pendulum to strike specimen.', '4. Record impact energy.'] },
  ...
  { id: 'astm-e1444', code: 'ASTM E1444', org: 'ASTM', prop: 'NDT', title: 'Standard Practice for Magnetic Particle Testing', scope: 'Detecting surface and near-surface defects in ferromagnetic materials.', specimen: 'Ferromagnetic parts.', params: 'Magnetizing current, particle type (wet/dry, fluorescent).', procedure: ['1. Clean surface.', '2. Magnetize part.', '3. Apply magnetic particles.', '4. Inspect under appropriate lighting (e.g., UV).', '5. Demagnetize and clean.'] },
  { id: 'astm-e165', code: 'ASTM E165', org: 'ASTM', prop: 'NDT', title: 'Standard Practice for Liquid Penetrant Examination', scope: 'Detecting surface-breaking defects in nonporous materials.', specimen: 'Any non-porous solid.', params: 'Penetrant type, dwell time, developer.', procedure: ['1. Clean and dry surface.', '2. Apply penetrant and wait for dwell time.', '3. Remove excess penetrant.', '4. Apply developer.', '5. Inspect for bleed-out.'] },
  { id: 'astm-e114', code: 'ASTM E114', org: 'ASTM', prop: 'NDT', title: 'Standard Practice for Ultrasonic Pulse-Echo Straight-Beam Contact Testing', scope: 'Detecting internal defects and measuring thickness.', specimen: 'Solid materials transmitting sound appropriately.', params: 'Transducer frequency, couplant.', procedure: ['1. Apply couplant to surface.', '2. Place transducer on part.', '3. Observe ultrasonic echoes on display.', '4. Evaluate signal indications.'] },
  { id: 'astm-e1742', code: 'ASTM E1742', org: 'ASTM', prop: 'NDT', title: 'Standard Practice for Radiographic Examination', scope: 'Internal flaw detection using X-rays or Gamma rays.', specimen: 'Various components and welds.', params: 'Radiation source, exposure time, film/detector.', procedure: ['1. Position source, specimen, and detector.', '2. Expose to radiation.', '3. Process film or read digital image.', '4. Interpret radiographic image.'] },

  // Corrosion
  { id: 'astm-b117', code: 'ASTM B117', org: 'ASTM', prop: 'Corrosion', title: 'Standard Practice for Operating Salt Spray (Fog) Apparatus', scope: 'Relative corrosion resistance in a controlled salt fog environment.', specimen: 'Panels or actual parts.', params: '5% NaCl solution, 35°C chamber temp, exposure time.', procedure: ['1. Clean and support specimens in chamber.', '2. Subject to continuous salt fog.', '3. Inspect at specified intervals.', '4. Evaluate rust or blistering.'] },
  { id: 'astm-g31', code: 'ASTM G31', org: 'ASTM', prop: 'Corrosion', title: 'Standard Guide for Laboratory Immersion Corrosion Testing of Metals', scope: 'Determining mass loss and corrosion rate in chemical environments.', specimen: 'Coupons of known surface area.', params: 'Test solution, temperature, duration.', procedure: ['1. Weigh and measure specimen.', '2. Immerse in test solution.', '3. Remove, clean, and re-weigh.', '4. Calculate corrosion rate (e.g., mm/year).'] },
  { id: 'astm-g48', code: 'ASTM G48', org: 'ASTM', prop: 'Corrosion', title: 'Pitting and Crevice Corrosion Resistance of Stainless Steels', scope: 'Resistance to localized corrosion in chloride environments.', specimen: 'Coupons with or without crevice formers.', params: 'Ferric chloride solution, test temperature.', procedure: ['1. Prepare and weigh specimen.', '2. Attach crevice formers if required.', '3. Immerse in FeCl3 solution for 72 hours.', '4. Clean, weigh, and examine for pitting.'] },

  // Metallography & Physical
  { id: 'astm-e3', code: 'ASTM E3', org: 'ASTM', prop: 'Metallography', title: 'Standard Guide for Preparation of Metallographic Specimens', scope: 'Guidelines for cutting, grinding, and polishing.', specimen: 'Sectioned material mount.', params: 'Abrasive grit size, polishing suspension.', procedure: ['1. Section the sample avoiding overheating.', '2. Mount in resin.', '3. Grind with successively finer abrasives.', '4. Polish to a mirror finish.', '5. Etch if necessary.'] },
  { id: 'astm-e112', code: 'ASTM E112', org: 'ASTM', prop: 'Metallography', title: 'Standard Test Methods for Determining Average Grain Size', scope: 'Measurement of grain size primarily for single-phase structures.', specimen: 'Polished and etched cross-section.', params: 'Microscope magnification limit.', procedure: ['1. Prepare and etch specimen.', '2. View under optical microscope.', '3. Use comparison, intercept, or planimetric method.', '4. Calculate ASTM grain size number.'] },
  { id: 'astm-e45', code: 'ASTM E45', org: 'ASTM', prop: 'Metallography', title: 'Standard Test Methods for Determining the Inclusion Content of Steel', scope: 'Rating of nonmetallic inclusions.', specimen: 'Polished longitudinal section.', params: 'Microscope field area.', procedure: ['1. Polish specimen (do not etch).', '2. Scan specific area under microscope.', '3. Classify inclusions by type (A, B, C, D) and thickness.', '4. Report severity level.'] },
  { id: 'astm-d792', code: 'ASTM D792', org: 'ASTM', prop: 'Physical', title: 'Standard Test Methods for Density and Specific Gravity (Relative Density) of Plastics by Displacement', scope: 'Density determination using Archimedes principle.', specimen: 'Solid block or molded part.', params: 'Immersion liquid (water), temperature.', procedure: ['1. Weigh specimen in air.', '2. Weigh specimen immersed in liquid.', '3. Calculate specific gravity/density based on displaced volume.'] },

  // Thermal
  { id: 'astm-e1269', code: 'ASTM E1269', org: 'ASTM', prop: 'Thermal', title: 'Standard Test Method for Determining Specific Heat Capacity by Differential Scanning Calorimetry', scope: 'Specific heat capacity measurement as a function of temperature.', specimen: 'Small sample (mg range) in crucible.', params: 'Heating rate (e.g., 20°C/min), protective gas.', procedure: ['1. Weigh sample into crucible.', '2. Run baseline, sapphire standard, and sample.', '3. Compare heat flow signals.', '4. Calculate specific heat capacity (Cp).'] },
  { id: 'astm-e1461', code: 'ASTM E1461', org: 'ASTM', prop: 'Thermal', title: 'Standard Test Method for Thermal Diffusivity by the Flash Method', scope: 'Thermal diffusivity measurement.', specimen: 'Small disc.', params: 'Laser pulse energy, temperature.', procedure: ['1. Coat faces of specimen with graphite.', '2. Condition to test temperature.', '3. Pulse front face with laser.', '4. Measure temperature rise on rear face.', '5. Calculate thermal diffusivity.'] }
];

const TEST_TYPES = ['Tensile', 'Compression', 'Flexural', 'Hardness', 'Impact', 'Fatigue', 'Fracture', 'Creep', 'NDT', 'Corrosion', 'Metallography', 'Physical', 'Thermal'];
